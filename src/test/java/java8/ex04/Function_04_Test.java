...
public class Function_04_Test {
    ...
    // TODO AGE >=18
    Predicate<Person> adult = (value) -> value.getAge() >= 18;
    // end::adult[]
    ...
    Predicate<Person> lastnameIsFrance = (value) -> value.getLastname().equals("France");


    // TODO compléter la fonction
    // TODO le prédicat vérifie que le prénom est "Armor"
    Predicate<Person> firstnameIsArmor = (value) -> value.getFirstname().equals("Armor");
    // end::predicateand[]
    ...
    public void test_predicate_and() throws Exception {
        ...
        List<Person> result = personList.stream().filter(lastnameIsFrance).filter(firstnameIsArmor).collect(Collectors.toList());
